...
namespace goos::codegen {
  ...
  auto Compiler::visit_boolean([[maybe_unused]] const ast::expression::Boolean &boolean)
      -> Result<std::any, Box<crab::Error>> {
    return to_ok(builder.write_push_constant(boolean.get_state()));
  }

  auto Compiler::visit_decimal([[maybe_unused]] const ast::expression::Decimal &decimal)
      -> Result<std::any, Box<crab::Error>> {
  ...
  auto Compiler::visit_integer([[maybe_unused]] const ast::expression::Integer &integer)
      -> Result<std::any, Box<crab::Error>> {
  ...
  Compiler::visit_binary([[maybe_unused]] const ast::expression::Binary &binary) -> Result<std::any, Box<crab::Error>> {
    ...
    return crab::fallible<Box<err::Error>>(
        ...
        .and_then([&](auto operands) -> CompilerResult<Value> {
          ...
          switch (binary.get_op()) {
            ...
            case lexer::Operator::XOR:
              return builder.write<vm::op::Code::BIT_XOR>();
            case lexer::Operator::BIT_OR:
              return builder.write<vm::op::Code::BIT_OR>();
            case lexer::Operator::BIT_AND:
              return builder.write<vm::op::Code::BIT_AND>();
            case lexer::Operator::AND:
              return builder.write<vm::op::Code::AND>();
            case lexer::Operator::OR:
              return builder.write<vm::op::Code::OR>();
            case lexer::Operator::NOT:
              return builder.write<vm::op::Code::NOT>();
            case lexer::Operator::EQUALS:
              return builder.write<vm::op::Code::EQUALS>();
            ...
            case lexer::Operator::GREATER:
              return builder.write<vm::op::Code::GREATER_THAN>();
            case lexer::Operator::LESS:
              return builder.write<vm::op::Code::LESS_THAN>();
            case lexer::Operator::GREATER_OR_EQUALS:
              return builder.write<vm::op::Code::GREATER_OR_EQUAL_THAN>();
            case lexer::Operator::LESS_OR_EQUALS:
              return builder.write<vm::op::Code::LESS_OR_EQUAL_THAN>();
            case lexer::Operator::SHIFT_LEFT:
              return builder.write<vm::op::Code::SHIFT_LEFT>();
            case lexer::Operator::SHIFT_RIGHT:
              return builder.write<vm::op::Code::SHIFT_RIGHT>();
            case lexer::Operator::ADD:
              return builder.write<vm::op::Code::ADD>();
            case lexer::Operator::SUB:
              return builder.write<vm::op::Code::SUBTRACT>();
            case lexer::Operator::MUL:
              return builder.write<vm::op::Code::MULIPLY>();
            case lexer::Operator::DIV:
              return builder.write<vm::op::Code::DIVIDE>();
            case lexer::Operator::MOD:
              return builder.write<vm::op::Code::MODULO>();
  ...
  auto Compiler::visit_scope([[maybe_unused]] const ast::expression::ScopeBlock &scope)
    ...
    while (builder.get_stack_tracker() + 1 > starting_stack) {
      builder.write<vm::op::Code::POP>();
    }
